        document.addEventListener('DOMContentLoaded', function () {
            ...
            // const updateGridBtn = document.getElementById('update-grid-btn'); // REMOVED
            ...
            let typeIndex = 0; // Initialized by updateIndices
            ...
            function renderGrid() {
                ...
                } catch(e) { console.error("Error parsing venue layout", e); }
                ...
                for (let r = 1; r <= totalRows; r++) {
                    for (let c = 1; c <= totalColumns; c++) {
                        ...
                        // Check if cell is void in venue layout
                        const voidCell = venueLayout.find(l => l.r === r && l.c === c && l.type === 'void');

                        if (voidCell) {
                            cell.style.backgroundColor = '#ef4444'; // Red for void
                            cell.style.color = '#fff';
                            cell.style.cursor = 'not-allowed';
                            cell.setAttribute('title', `Zone Non Assignable${voidCell.label ? ': ' + voidCell.label : ''}`);
                            cell.classList.add('void-cell'); // Marker class
                ...
                Object.keys(uniquePlans).forEach(name => {
                    ...
                    legendItem.innerHTML = `
                        <span class="color-display mr-2 w-6 h-3" style="background-color: ${planData.color};"></span>
            ...
            function setActiveSelection(index) {
                ...
                if (currentlyActive) {
                    ...
                    const oldIconContainer = currentlyActive.querySelector('.lock-icon-container');
                    if (oldIconContainer) {
                ...
                if (index === activeTicketTypeIndex) {
                    ...
                    if (newActiveRow) {
                        ...
                        const newIconContainer = newActiveRow.querySelector('.lock-icon-container');
                        if (newIconContainer) {
            ...
            // updateGridBtn.addEventListener('click', function(e) { // REMOVED
            //    e.preventDefault();
            //    renderGrid();
            // });
            ...
            planGrid.addEventListener('mousedown', function(e) {
                ...
                if (cell) {
                    if (cell.classList.contains('void-cell')) return; // Ignore void cells
